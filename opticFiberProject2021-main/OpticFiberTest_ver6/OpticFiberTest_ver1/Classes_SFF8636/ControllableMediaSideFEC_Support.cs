...
{
    class ControllableMediaSideFEC_Support : SFF8636
    {
        public ControllableMediaSideFEC_Support()
        {
            m_title = "Controllable Madia Side FEC Support";
            m_size = 1;
            m_FirstBit = 6;
            m_LastBit = 6;
            m_address = 227;
            ...
            m_dict.Add(0, "\n\tModule’s media-side FEC, if any, is not \n\tcontrollable by the host\n");
            m_dict.Add(1, "\n\t Module can generate and terminate FEC \n\tencoding from and to the media under control of\n\tthe host\n");
        }
        /****************************************************************
